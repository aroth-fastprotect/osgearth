...
MACRO(SET_OUTPUT_DIR TARGET_TARGETNAME RELATIVE_OUTDIR)
    # Global properties (All generators but VS & Xcode)
    SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/lib/${RELATIVE_OUTDIR}")
    SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/bin/${RELATIVE_OUTDIR}")
    SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/lib/${RELATIVE_OUTDIR}")
    ...
    FOREACH(CONF ${CMAKE_CONFIGURATION_TYPES})        # For each configuration (Debug, Release, MinSizeRel... and/or anything the user chooses)
        ...
        SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES "ARCHIVE_OUTPUT_DIRECTORY_${CONF}" "${CMAKE_BINARY_DIR}/lib/${RELATIVE_OUTDIR}")
        SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES "RUNTIME_OUTPUT_DIRECTORY_${CONF}" "${CMAKE_BINARY_DIR}/bin/${RELATIVE_OUTDIR}")
        SET_TARGET_PROPERTIES(${TARGET_TARGETNAME} PROPERTIES "LIBRARY_OUTPUT_DIRECTORY_${CONF}" "${CMAKE_BINARY_DIR}/lib/${RELATIVE_OUTDIR}")
...
# here we use the command to generate the library
    ...
    SET_OUTPUT_DIR(${TARGET_TARGETNAME} ${OSG_PLUGINS})
